    ...
    <div className="container mt-5 text-center mb-5">
      ...
      <div className="supliers">
        <div className="style">
          ...
          />
          <h5 className="text-danger">Name: Alamin Sorkar</h5>
        ...
        <div className="style">
          <img
            ...
            className="mb-3 border rounded-circle"
          />
          <h5 className="text-danger">Name: Hasan Hossain</h5>
          <p className="me-5 ms-5 mt-3 text-secondary">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi,
            tempore!
          </p>
        ...
        <div className="style">
          <img
            ...
            className="mb-3 border rounded-circle"
          />
          <h5 className="text-danger">Name: Hossen Sorkar</h5>
          <p className="me-5 ms-5 mt-3 text-secondary">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi,
            tempore!
          </p>
        ...
        <div className="style"> 
          <img
            ...
            className="mb-3 border rounded-circle"
          />
          <h5 className="text-danger">Name: Ikhtiar Uddin</h5>
          <p className="me-5 ms-5 mt-3 text-secondary">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi,
            tempore!
          </p>
        ...
        <div className="style">
          <img
            ...
            className="mb-3 border rounded-circle"
          />
          <h5 className="text-danger">Name: Babul Ahmed</h5>
          <p className="me-5 ms-5 mt-3 text-secondary">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi,
            tempore!
          </p>
        ...
        <div className="style">
          <img
            ...
            className="mb-3 border rounded-circle"
          />
          <h5 className="text-danger">Name: Babul Mia</h5>
          <p className="me-5 ms-5 mt-3 text-secondary">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi,
            tempore!
          </p>
